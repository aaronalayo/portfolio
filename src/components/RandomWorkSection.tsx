...
//         {/* The Text Overlay is now back in the center, providing clear content for Google */}
//         <div className="absolute inset-0 z-20 flex flex-col items-center justify-center text-center text-white bg-black bg-opacity-40 p-4 pointer-events-none">
//           <h1 className="font-veep font-bold text-4xl md:text-6xl uppercase tracking-wider drop-shadow-lg">
//             Aaron Alayo
//           </h1>
//           <p className="mt-4 text-lg md:text-xl max-w-2xl drop-shadow-md">
//             Creative Portfolio: Videography, Photography & Web Development
//           </p>
//         </div>
